    ...
    public start(): Promise<boolean> {
        ...
        return new Promise(function (fulfill, reject) {
            try {
                ...
                that.rest.get('/echo/:msg', (req,res,next) => that.router.echo(req,res,next));

                // Other endpoints will go here
                that.rest.put('/dataset/:id',(req,res,next) => that.router.put(req,res,next));
                that.rest.post('/query',(req,res,next) => that.router.post(req,res,next));
                that.rest.del('/dataset/:id',(req,res,next) => that.router.del(req,res,next));
